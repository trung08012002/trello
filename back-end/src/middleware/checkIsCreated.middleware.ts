...
const checkCreatedByMiddleware = <T>(database: T extends Collection ? any : any) => {
  return async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (!itemsWithCreatedBy.createdBy._id.equals(req.user?._id)) {
...
export default checkCreatedByMiddleware
